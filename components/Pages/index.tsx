...
const Page: PageEl = (props, state:
  ...
  {form:string,
  book:{title:string,author:string,country,imageLink:string,price:number,language:string,pages:number,
  ...
  return (
    <div style={{ direction: "rtl", minHeight: "11vh", }}>
      ...
      {state.form == "bookspecs" ? <WindowFloat
        ...
        state.cart.includes(state.book.title)?"#c43d3d":
      ...
      <Window title="سبد خرید" style={{margin:10,
            width: "calc(100% - 20px)"}}>
